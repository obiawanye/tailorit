    ...
    try {
      ...
      if (error) {
        ...
        if (
          ...
          errorCode === 'form_identifier_not_found_for_instance'
        ) {
          openAuthModal(
            'Account not found',
    ...
    <AuthLayout>
      <div className="w-full text-white">
          ...
          <div className="flex items-center justify-between pt-2">
            <label className="flex cursor-pointer items-center gap-3 text-xs text-white/60 sm:text-sm">
              <input
                ...
                className="h-4 w-4 cursor-pointer rounded border-white/40 accent-[#ff5a00]"
              />
        ...
        <button
          ...
          className="flex h-12 w-full items-center justify-center gap-3 rounded-md border border-white/70 bg-transparent text-sm font-normal text-white transition hover:bg-white/10 disabled:cursor-not-allowed disabled:opacity-60"
        >
          <FcGoogle size={20} />
